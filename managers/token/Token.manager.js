...
module.exports = class TokenManager {
    ...
    constructor({config}){
        this.config              = config;
        this.longTokenExpiresIn  = this.config.dotEnv.LONG_TOKEN_EXPIRY;
        this.shortTokenExpiresIn = this.config.dotEnv.SHORT_TOKEN_EXPIRY;
    ...
    v1_createShortToken({__token, __device}){
